	...
	Funcion opcion=presentarMenu(titulo,menu,lim)
		...
		leer opcion
FinFuncion
Algoritmo Proyecto_investigacion
				...
				Mientras opcn <> "11" Hacer         
					...
					Segun opcn Hacer
						...
						"2":
							...
							Definir num,num2,coc Como Entero
				...
				Mientras opcn <> "11" Hacer         
					...
					Segun opcn Hacer
						...
						"8":
							...
							Definir x,suma,csc,c Como Entero
							Definir cadnum , sc Como Caracter
							Escribir "ESCRIBIR EL NUMERO DE CEDULA: "
							Leer cadnum
							c=0
							suma=0
							x=Longitud(cadnum)
							...
							Mientras c<x Hacer
								sc=Subcadena(cadnum,c,c)
								
								csc=ConvertirANumero(sc)
								
								suma=suma+csc
								c=c+1
							FinMientras
							Escribir "LA DE SU CADENA ES :","  ",suma
							Esperar 3 Segundos
						"9":
